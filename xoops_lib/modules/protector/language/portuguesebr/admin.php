...
define("_AM_TXT_HOWTOCHANGEDB","Ao mudar o prefixo, voc?deve alterar o seguinte conteúdo em %s/mainfile.php.<br /><br />define('XOOPS_DB_PREFIX', '<b>%s</b>');");
...
define("_AM_ADV_ALLOWURLFOPEN","Esta configuração permite que atacantes executem scripts remotamente ?vontade.<br />Para alterar esta opção, ?necessário ter permissão de administrador do servidor.<br />Se for um administrador do servidor, edite o php.ini e o httpd.conf.<br /><b>Exemplo de httpd.conf:<br /> &nbsp; php_admin_flag &nbsp; allow_url_fopen &nbsp; off</b><br />Caso contrário, contate o suporte de seu host.");
...
define("_AM_ADV_DBPREFIX","O prefixo do seu banco de dados ?o padrão (\"xoops\"), o que o faz vulnerá×el ?SQL injection.<br />Não se esqueça de ativar \"Sanitização em caso de detecção de comentários isolados\" e as proteções contra SQL injection.");
