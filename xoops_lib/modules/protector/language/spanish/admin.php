...
define( "_AM_JS_REMOVECONFIRM" , "¿Est?seguro de la eliminación?" ) ;
...
define("_AM_ADV_USETRANSSID","Su ID de sesión ser?mostrada en etiquetas ancla, etc.<br />Para evitar el secuestro de sesión, añada una línea en el archivo .htaccess de la raíz de XOOPS.<br /><b>php_flag session.use_trans_sid off</b>");
