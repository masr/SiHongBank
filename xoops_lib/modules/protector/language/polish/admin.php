...
define( "_AM_MSG_BADIPSCANTOPEN" , "Plik z zablokowanymi adresami IP nie mo¿e zosta?odczytany" ) ;
define( "_AM_MSG_GROUP1IPSCANTOPEN" , "Plik z adresami IP dla grupy=1 nie mo¿e zosta?odczytany" ) ;
...
define("_AM_ADV_ALLOWURLFOPEN","To ustawienie pozwala na wykonanie niechcianych skryptów na zdalnych serwerach.<br />tylko administrator serwera mo¿e zmieni?t?opcje.<br />Je¿eli nim jeste? wyedytuj php.ini lub httpd.conf.<br /><b>Przyk³ad edycji httpd.conf:<br /> &nbsp; php_admin_flag &nbsp; allow_url_fopen &nbsp; off</b><br />Je¶li nie jeste?adminem serwera, popro?go o to!.");
define("_AM_ADV_USETRANSSID","Twoje ID sesji bêdzie widoczne w tagach odno¶ników.<br />Aby zabezpieczy?si?przed kradzie¿± sesji, dodaj nastêpuj±c?lini?w pliku .htaccess w katalogu XOOPS_ROOT_PATH.<br /><b>php_flag session.use_trans_sid off</b>");
