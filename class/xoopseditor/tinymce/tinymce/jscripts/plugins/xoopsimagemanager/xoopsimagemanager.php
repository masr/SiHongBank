 ...
 * @version         $Id: xoopsimagemanager.php 2812 2009-02-17 01:44:02Z dugris $
 */
...
function imageBrowser( $inputname = "src", $canbrowse = false ) {
    $html = "";
    if ( $canbrowse ) {
        $html = "<img title=\"{#xoopsimagemanager.desc}\" class=\"xoopsimagebrowser\" src=\"img/xoopsimagemanager.png\"
