 ...
 * @version         $Id: xoopsmlcontent.php 2810 2009-02-16 18:30:37Z dugris $
 */
    ...
    <div class="panel_wrapper">
        <div id="mlcontent_panel" class="panel current" style="overflow:auto;">
            ...
            <div class="mceActionPanel floatright">
                <input type="submit" id="insert" name="insert" value="{$lang_insert}" onclick="XoopsmlcontentDialog.insertMLC();return false;"/>
