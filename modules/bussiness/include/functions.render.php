 ...
 */
function bussiness_getTemplate($page = "index", $style = null)
{
    global $xoops;
 ...
 * @return array
 */
function &bussiness_getTemplateList($page = "index", $refresh = false)
{
    $TplFiles = bussiness_getTplPageList($page, $refresh);
    $template = array();
 ...
 * 
 * The hardcoded path is not desirable for theme switch, however, we have to kebussiness it before getting a good solution for cache
 *
 * @var string     $style
 *
 * @return string    file URL, false if not found
 */
function bussiness_getCss($style = "default")
{
    global $xoops;
 ...
 * @return string
 */
function bussiness_getModuleHeader($style = "default")
{
    $xoops_module_header = "<link rel=\"stylesheet\" type=\"text/css\" href=\"" . bussiness_getCss($style) . "\" />";
 ...
 * @return array
 */
function &bussiness_getTplPageList($page = "", $refresh = true)
{
    $list = null;
    ...
    */
    ...
    if ( !is_array($list) || $refresh ) {
        $list = bussiness_template_lookup(!empty($page));
    }
...
function &bussiness_template_lookup($index_by_page = false) 
{
