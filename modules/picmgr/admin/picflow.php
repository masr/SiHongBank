...
$_SESSION['in_what_pic_manager']=FLOW_TYPE;
$temp_pic=$picture_handler->create();

$form_add=new XoopsThemeForm('添加首页浮动图片', 'add_flow_pic', 'picupload.php?dir=flow');
...
$form = new XoopsThemeForm('更改首页浮动图片', 'edit_flow_pic', 'picupload.php');
	...
	<form action='picupload.php' method='post' accept-charset='utf-8'>
		...
		<div class='slide_pic'>
			<div class='slide_pic_img'>
				<img src='".XOOPS_URL."/uploads/{$upload_thumb_name[FLOW_TYPE]}/".$content->getVar('pic_file_name')."'  alt='{$content->getVar('pic_title')}' />
			</div>
