...
class XoopsTree
{
	...
	require_once( XOOPS_ROOT_PATH."/modules/$mydirname/include/gtickets.php" ) ;
		...
		while ( list($catid, $name, $ordre) = $xoopsDB->fetchRow($result) ) {
			...
			echo "<p><a href=\"category.php?op=NewCat&amp;cid=$catid\"><img src=\"".XOOPS_URL."/modules/$mydirname/images/plus.gif\" border=0 width=10 height=10 alt=\""._AM_JOBS_ADDSUBCAT."\"></a>&nbsp;<a href=\"category.php?op=ModCat&amp;cid=$catid\" title=\""._AM_JOBS_MODIFCAT."\">$name</a> ";
				if ($xoopsModuleConfig['classm'] == "ordre") { echo "($ordre)"; }				
				echo "<br />\n";
			$arr = $this->getChildTreeMapArray($catid, $order);
			foreach ( $arr as $option ) {
				$option['prefix'] = str_replace("."," --->",$option['prefix']);
				$catpath = $option['prefix']."&nbsp;<a href=\"category.php?op=NewCat&amp;cid=".$option[$this->id]."\"><img src=\"".XOOPS_URL."/modules/$mydirname/images/plus.gif\" border=0 width=10 height=10 alt=\""._AM_JOBS_ADDSUBCAT."\"></a>&nbsp;<a href=\"category.php?op=ModCat&amp;cid=".$option[$this->id]."\" title=\""._AM_JOBS_MODIFCAT."\">".$myts->makeTboxData4Show($option[$title]);
				$ordreS = $option['ordre'];
				echo "$catpath</a> ";
				if ($xoopsModuleConfig['classm'] == "ordre") { echo "($ordreS)"; }				
				echo "<br />\n";
	...
	require_once( XOOPS_ROOT_PATH."/modules/$mydirname/include/gtickets.php" ) ;
		...
		while ( list($catid, $name, $ordre) = $xoopsDB->fetchRow($result) ) {
			...
			echo "<p><a href=\"category.php?op=NewResCat&amp;cid=$catid\"><img src=\"".XOOPS_URL."/modules/$mydirname/images/plus.gif\" border=0 width=10 height=10 alt=\""._AM_JOBS_ADDSUBCAT."\"></a>&nbsp;<a href=\"category.php?op=ModResCat&amp;cid=$catid\" title=\""._AM_JOBS_MODIFCAT."\">$name</a> ";
				if ($xoopsModuleConfig['classm'] == "ordre") { echo "($ordre)"; }				
				echo "<br />\n";
			$arr = $this->getChildTreeMapArray($catid, $order);
			foreach ( $arr as $option ) {
				$option['prefix'] = str_replace("."," --->",$option['prefix']);
				$catpath = $option['prefix']."&nbsp;<a href=\"category.php?op=NewResCat&amp;cid=".$option[$this->id]."\"><img src=\"".XOOPS_URL."/modules/$mydirname/images/plus.gif\" border=0 width=10 height=10 alt=\""._AM_JOBS_ADDSUBCAT."\"></a>&nbsp;<a href=\"category.php?op=ModResCat&amp;cid=".$option[$this->id]."\" title=\""._AM_JOBS_MODIFCAT."\">".$myts->makeTboxData4Show($option[$title]);
				$ordreS = $option['ordre'];
				echo "$catpath</a> ";
				if ($xoopsModuleConfig['classm'] == "ordre") { echo "($ordreS)"; }				
				echo "<br />\n";
