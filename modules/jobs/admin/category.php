...
function NewCat($cat)
{
	...
	xoops_cp_header();
	//jobs_admin_menu(1 , _AM_JOBS_ADDSUBCAT);
	include( './mymenu.php' ) ;
	...
	echo "</select>&nbsp;&nbsp;<img src=\"".XOOPS_URL."/modules/$mydirname/images/cat/default.gif\" name=\"avatar\" align=\"absmiddle\"> </td></tr><tr><td>&nbsp;</td><td>"._AM_JOBS_REPIMGCAT." /modules/$mydirname/images/cat/</td></tr>";

		echo "<tr><td>"._AM_JOBS_DISPLPRICE2." </td><td><input type=\"radio\" name=\"affprice\" value=\"1\">"._AM_JOBS_OUI."&nbsp;&nbsp; <input type=\"radio\" name=\"affprice\" value=\"0\">"._AM_JOBS_NON." ("._AM_JOBS_INTHISCAT.")</td></tr>";
...
function ModCat($cat)
{
	...
	xoops_cp_header();
	//jobs_admin_menu(1 , _AM_JOBS_MODIFCAT);
	include( './mymenu.php' ) ;
	...
	echo "</select>&nbsp;&nbsp;<img src=\"".XOOPS_URL."/modules/$mydirname/images/cat/$imgs\" name=\"avatar\" align=\"absmiddle\"> </td></tr><tr><td>&nbsp;</td><td>"._AM_JOBS_REPIMGCAT." /modules/$mydirname/images/cat/</td></tr>";

		echo "<tr><td>"._AM_JOBS_DISPLPRICE2." </td><td><input type=\"radio\" name=\"affprice\" value=\"1\""; if ($affprice == "1") echo "checked"; 
		echo ">"._AM_JOBS_OUI."&nbsp;&nbsp; <input type=\"radio\" name=\"affprice\" value=\"0\""; if ($affprice == "0") echo "checked"; echo ">"._AM_JOBS_NON." ("._AM_JOBS_INTHISCAT.")</td></tr>";
	...
	echo "<input type=\"hidden\" name=\"cidd\" value=\"$cat\">"
		...
		."<input type=\"submit\" value=\""._AM_JOBS_SAVMOD."\"></form></td></tr><tr><td><br />"
...
function ModCatS($cidd, $cid, $img, $title, $ordre, $affprice)
{
	...
	redirect_header("map.php",1,_AM_JOBS_CATSMOD);
	exit();
}
...
function AddCat($title, $cid, $img, $ordre, $affprice) 
{
	...
	redirect_header("map.php",1,_AM_JOBS_CATADD);
	exit();
}
...
function DelCat($cid, $ok=0) {
	...
	if(intval($ok)==1) {
		...
		redirect_header("map.php",1,_AM_JOBS_CATDEL);
		exit();   
	} else {
		xoops_cp_header();
		OpenTable();
...
function ModResCat($cat)
{
	...
	echo "</select>&nbsp;&nbsp;<img src=\"".XOOPS_URL."/modules/$mydirname/images/cat/$imgs\" name=\"avatar\" align=\"absmiddle\"> </td></tr><tr><td>&nbsp;</td><td>"._AM_JOBS_REPIMGCAT." /modules/$mydirname/images/cat/</td></tr>";
		...
		echo "<tr><td>"._AM_JOBS_DISPLPRICE2." </td></td colspan=2><input type=\"radio\" name=\"affprice\" value=\"1\""; if ($affprice == "1") echo "checked"; 
		echo ">"._AM_JOBS_OUI."&nbsp;&nbsp; <input type=\"radio\" name=\"affprice\" value=\"0\""; if ($affprice == "0") echo "checked"; echo ">"._AM_JOBS_NON." ("._AM_JOBS_INTHISCAT.")</td></tr>";
