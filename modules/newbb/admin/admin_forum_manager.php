 ...
 * @version         $Id: admin_forum_manager.php 2167 2008-09-23 13:33:57Z phppp $
 */
...
switch ($op) {
    ...
    case "save":
        ...
        if ($forum_handler->insert($forum_obj)) {
            ...
            redirect_header("admin_forum_manager.php?op=mod&amp;forum=" . $forum_obj->getVar('forum_id'), 2, $message);
            exit();
        } else {
    ...
    default:
		...
		$permission_handler->createPermData("forum_all");
        ...
        foreach (array_keys($categories) as $c) {
            ...
            foreach (array_keys($forums[$c]) as $f) {
                ...
                $f_edit_link = "<a href=\"admin_forum_manager.php?op=mod&amp;forum=" . $f . "\">" . newbb_displayImage('admin_edit') . "</a>";
                $f_del_link = "<a href=\"admin_forum_manager.php?op=del&amp;forum=" . $f . "\">" . newbb_displayImage('admin_delete') . "</a>";
                $sf_add_link = "<a href=\"admin_forum_manager.php?op=addforum&amp;cat_id=" . $c . "&forum=" . $f . "\">" . newbb_displayImage('new_forum') . "</a>";
                $f_move_link = "<a href=\"admin_forum_manager.php?op=moveforum&amp;forum=" . $f . "\">" . newbb_displayImage('admin_move') . "</a>";
                $f_merge_link = "<a href=\"admin_forum_manager.php?op=mergeforum&amp;forum=" . $f . "\">" . newbb_displayImage('admin_move') . "</a>";
