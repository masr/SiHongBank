<?php
// $Id: update.php,v 1.7 2006/04/25 16:24:44 m0nty_ Exp $
//  ------------------------------------------------------------------------ //
...
function xoops_module_update_wfdownloads($module) {
    ...
    wfdownloads_SetMeta("version", "3.10.007"); //Set meta version to current
    return true;
}
...
function update_tables_to_300()
{
	...
	"description" => array("Type" => "varchar(255) NOT NULL default ''", "Default" => true),
