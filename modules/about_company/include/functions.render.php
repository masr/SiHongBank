 ...
 */
function about_company_getTemplate($page = "index", $style = null)
{
    global $xoops;
 ...
 * @return array
 */
function &about_company_getTemplateList($page = "index", $refresh = false)
{
    $TplFiles = about_company_getTplPageList($page, $refresh);
    $template = array();
 ...
 * 
 * The hardcoded path is not desirable for theme switch, however, we have to keabout_company it before getting a good solution for cache
 *
 * @var string     $style
 *
 * @return string    file URL, false if not found
 */
function about_company_getCss($style = "default")
{
    global $xoops;
 ...
 * @return string
 */
function about_company_getModuleHeader($style = "default")
{
    $xoops_module_header = "<link rel=\"stylesheet\" type=\"text/css\" href=\"" . about_company_getCss($style) . "\" />";
 ...
 * @return array
 */
function &about_company_getTplPageList($page = "", $refresh = true)
{
    $list = null;
    ...
    */
    ...
    if ( !is_array($list) || $refresh ) {
        $list = about_company_template_lookup(!empty($page));
    }
...
function &about_company_template_lookup($index_by_page = false) 
{
